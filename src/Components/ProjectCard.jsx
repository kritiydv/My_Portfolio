...
const ProjectCard = ({ title, main, date, desc, imgSrc, demoLink, sourceLink }) => {
  return (
    <div className="p-3 md:p-6 flex flex-col w-[270px] md:w-[320px] lg:w-[370px] h-[420px] md:h-[470px] bg-[#0c0e19] shadow-xl shadow-slate-900 rounded-2xl">
      {/* Image */}
      <img
        className="p-4 h-[180px] w-full object-cover rounded-lg"
        src={imgSrc}
        alt={`${title} preview`}
      />
